                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div>
                            ...
                            <div className="text-3xl flex gap-4 pt-4">
                                <a
                                    href="https://www.facebook.com/profile.php?id=100080751632307"
                                    target="_blank"
                                    className="fa-brands fa-facebook cursor-pointer hover:text-yellow-300"
                                />
                                <a
                                    href="https://www.instagram.com/mostafa_0x/"
                                    target="_blank"
                                    className="fa-brands fa-instagram hover:text-yellow-300"
                                />
                            </div>
                        </div>
                    </div>
