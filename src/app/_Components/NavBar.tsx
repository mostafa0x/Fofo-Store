        ...
        <div className="navbar  bg-white fixed top-0 z-[55] pl-10 pr-10 pt-5">
            <div className="flex-1">
                <div className=' flex gap-6'>
                    ...
                    <input onKeyDown={(e) => { if (e.key == "Enter") { Search(SearchBar?.current?.value ?? "") } }} ref={SearchBar} type="text" placeholder="Search here for products" className="outline-none !max-w-none" style={{ width: `${MaxInputChrs}px` }} />
                    {LoadingIconOptions ?
                        <div role="status">
                        ...
                        : <div className=' flex flex-row'>
                            <select id='mySelect' onClick={() => selectMax(Op?.current?.value?.length ?? 0, (Op.current?.value ?? "All"))} ref={Op} className='outline-none'
