        ...
        <div className="navbar fixed top-0 bg-base-100 shadow-sm z-[60]">
            ...
            <div className="flex gap-2">
                {UserToken ? isLoadingCartIcon ? <div role="status">
                    ...
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle pr-4">
                ...
                {LoadingIconOptions ? <div role="status">
                    ...
                    <span className="sr-only">Loading...</span>
                </div> : <select ref={Selector} defaultValue="All" className="select " onClick={(e) => {
                ...
                {isUserLoading ? <div role="status">
                    ...
                    {UserToken ?
                        <ul
                            ...
                            <li onClick={() => LogOut()}><i>Logout</i></li>
                        </ul>
                        : null}
                </div>}
